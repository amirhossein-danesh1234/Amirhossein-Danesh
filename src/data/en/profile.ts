...
export const profile = {
  ...
  location: '', profileImage: '/profile-placeholder.svg',
  socialLinks: [
    { label: 'GitHub', href: 'https://github.com/amirhossein-danesh1234', external: true }, { label: 'LinkedIn', href: '', external: true }, { label: 'Telegram', href: '', external: true }, { label: 'Email', href: '', external: false }, { label: 'CV', href: '/resume', external: false },
